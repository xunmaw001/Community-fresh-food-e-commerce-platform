<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责品类" prop="fuzepinlei">
          <el-input v-model="ruleForm.fuzepinlei" 
              placeholder="负责品类" clearable  :readonly="ro.fuzepinlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="负责品类" prop="fuzepinlei">
              <el-input v-model="ruleForm.fuzepinlei" 
                placeholder="负责品类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='fuzepinlei'){
            this.ruleForm.fuzepinlei = obj[o];
	    this.ro.fuzepinlei = true;
            continue;
          }
          if(o=='lianxidianhua'){
